...
const QString PLS_RTMP_ADD_V2_DEV = PRISM_AUTH_API_BASE_DEV;
const QString PLS_RTMP_MODIFY_V2_DEV = PRISM_AUTH_API_BASE_DEV;
const QString PLS_RTMP_DELETE_V2_DEV = PRISM_AUTH_API_BASE_DEV;
const QString PLS_RTMP_LIST_V2_DEV = PRISM_AUTH_API_BASE_DEV;

// prism sidekick api
// http://dev.sidekick.prismlive.com/
...
// prism sync api
// http://dev-sync.prism.navercorp.com/
...
const QString PRISM_NCP_AUTH_API_DEV = PRISM_AUTH_API_BASE_DEV;
const QString PRISM_NCP_AUTH_JOIN_API_DEV = PRISM_AUTH_API_BASE_DEV;
const QString PRISM_NCP_REFRESH_TOKEN_API_DEV = PRISM_AUTH_API_BASE_DEV;
const QString PRISM_NCP_SERVICE_CONFIG_API_DEV = PRISM_AUTH_API_BASE_DEV;
...
MAKE_IMPL2(PLS_RTMP_ADD_V2, PRISM_AUTH_API_BASE);
MAKE_IMPL2(PLS_RTMP_MODIFY_V2, PRISM_AUTH_API_BASE);
MAKE_IMPL2(PLS_RTMP_DELETE_V2, PRISM_AUTH_API_BASE);
MAKE_IMPL2(PLS_RTMP_LIST_V2, PRISM_AUTH_API_BASE);
...
MAKE_IMPL2(PRISM_NCP_AUTH_API, PRISM_AUTH_API_BASE);
MAKE_IMPL2(PRISM_NCP_SERVICE_ID_API, "");
MAKE_IMPL2(PRISM_NCP_AUTH_JOIN_API, PRISM_AUTH_API_BASE);
MAKE_IMPL2(PRISM_NCP_REFRESH_TOKEN_API, PRISM_AUTH_API_BASE);
MAKE_IMPL2(PRISM_NCP_SERVICE_CONFIG_API, "");
